// Code by Muhammad Asjad Kashif
#include <iostream>
#include <conio.h> //used getch() function to hold the program
using namespace std;
// 6 Curriences
//  Function to convert Pakistani currency.
double convertpkrinusd(double amount) // pkr amount given
{
	return amount * 0.012;
}
...
int main()
{
	...
	do
	{
		...
		else if (currency == "TRY") // CHANGE CURRIENCES IN TURKISH LIRA
		{
		...
		else if (currency == "JPY") // CHANGE CURRENCIES IN JAPANESE YEN
		{
			cout << "__________________________________________________________________" << endl;
		...
		else if (currency == "PKR") // CHANGE CURRENCIES IN PAKISTANI RUPEES
		{
